<html class=" js flexbox canvas canvastext webgl no-touch geolocation postmessage websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms csstransforms3d csstransitions fontface generatedcontent video audio localstorage sessionstorage webworkers no-applicationcache svg inlinesvg smil svgclippaths" lang="en" style="" jstcache="0">
<?php include "includes/head.php";?> 
    <body class="contact" jstcache="0">
        <!--[if lt IE 8]>
        ...
        <!-- header-area-start -->
		<?php include "includes/header.php";?>        <!-- header-area-end -->
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						<div class="contact-form">
							...
							<div class="single-form-3">
								<form action="#">
									<textarea name="massage" placeholder="Massage" cols="30" rows="10"></textarea>
